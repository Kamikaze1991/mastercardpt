...
namespace Pbo.App.MastercardApi.Client.Model
{
    ...
    public partial class AccountBase : IEquatable<AccountBase>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="enrollmentDate">The date for when the account becomes eligible for rewards program. If undefined, enrollment date is defaulted to the date when Mastercard processes the enrollment. benefits.</param>
        ...
        public AccountBase(string accountId = default(string), string accountIdType = default(string), DateTime enrollmentDate = default(DateTime), DateTime openDate = default(DateTime), string productCode = default(string), string programIdentifier = default(string), string status = default(string), bool accruePoints = default(bool), bool primaryAccount = default(bool), string householdToken = default(string), string userDefined1 = default(string), string userDefined2 = default(string), string userDefined3 = default(string), string userDefined4 = default(string), string userDefined5 = default(string), string userDefined6 = default(string), string userDefined7 = default(string), string userDefined8 = default(string))
        {
            // to ensure "accountId" is required (not null)
            this.AccountId = accountId ?? throw new ArgumentNullException("accountId is a required property for AccountBase and cannot be null");
            // to ensure "accountIdType" is required (not null)
            this.AccountIdType = accountIdType ?? throw new ArgumentNullException("accountIdType is a required property for AccountBase and cannot be null");
            // to ensure "productCode" is required (not null)
            this.ProductCode = productCode ?? throw new ArgumentNullException("productCode is a required property for AccountBase and cannot be null");
            // to ensure "programIdentifier" is required (not null)
            this.ProgramIdentifier = programIdentifier ?? throw new ArgumentNullException("programIdentifier is a required property for AccountBase and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for AccountBase and cannot be null");
        ...
        /// <summary>
        /// The date for when the account becomes eligible for rewards program. If undefined, enrollment date is defaulted to the date when Mastercard processes the enrollment. benefits
        /// </summary>
        /// <value>The date for when the account becomes eligible for rewards program. If undefined, enrollment date is defaulted to the date when Mastercard processes the enrollment. benefits</value>
