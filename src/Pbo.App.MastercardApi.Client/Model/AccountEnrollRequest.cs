...
namespace Pbo.App.MastercardApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AccountEnrollRequest")]
    public partial class AccountEnrollRequest : IEquatable<AccountEnrollRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEnrollRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountEnrollRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountEnrollRequest" /> class.
        /// </summary>
        /// <param name="accountId">The unique identifier for the given account. (required).</param>
        /// <param name="accountIdType">Identifier type for the given account. Possible values are BAN (the Bank Account Number) and RANAC (the unique account identifier assigned by Mastercard and provided to the client in the account enrollment) (required).</param>
        ...
        /// <param name="productCode">The account’s associated reward product identifier as defined by the client and configured during the implementation of the program. (required).</param>
        /// <param name="programIdentifier">Program identifier for the program in which the cardholder is enrolled. Program ID is created by Mastercard Rewards System. (required).</param>
        ...
        /// <param name="userId">The unique identifier of the User (required).</param>
        /// <param name="userIdType">Identifier type of the User. Possible values are BCN (the Bank Customer Number) and RANCU (The unique account identifier assigned by Mastercard and provided to the client in the account enrollment) (required).</param>
        ...
        public AccountEnrollRequest(string accountId = default(string), string accountIdType = default(string), long companyIca = default(long), DateTime enrollmentDate = default(DateTime), DateTime openDate = default(DateTime), string productCode = default(string), string programIdentifier = default(string), string status = default(string), string userId = default(string), string userIdType = default(string), bool accruePoints = default(bool), string householdToken = default(string), bool primaryAccount = default(bool), PcloAccountStatusCodeEnum? pcloAccountStatusCode = default(PcloAccountStatusCodeEnum?), string userDefined1 = default(string), string userDefined2 = default(string), string userDefined3 = default(string), string userDefined4 = default(string), string userDefined5 = default(string), string userDefined6 = default(string), string userDefined7 = default(string), string userDefined8 = default(string))
        {
            // to ensure "accountId" is required (not null)
            this.AccountId = accountId ?? throw new ArgumentNullException("accountId is a required property for AccountEnrollRequest and cannot be null");
            // to ensure "accountIdType" is required (not null)
            this.AccountIdType = accountIdType ?? throw new ArgumentNullException("accountIdType is a required property for AccountEnrollRequest and cannot be null");
            this.CompanyIca = companyIca;
            // to ensure "productCode" is required (not null)
            this.ProductCode = productCode ?? throw new ArgumentNullException("productCode is a required property for AccountEnrollRequest and cannot be null");
            // to ensure "programIdentifier" is required (not null)
            this.ProgramIdentifier = programIdentifier ?? throw new ArgumentNullException("programIdentifier is a required property for AccountEnrollRequest and cannot be null");
            // to ensure "status" is required (not null)
            this.Status = status ?? throw new ArgumentNullException("status is a required property for AccountEnrollRequest and cannot be null");
            // to ensure "userId" is required (not null)
            this.UserId = userId ?? throw new ArgumentNullException("userId is a required property for AccountEnrollRequest and cannot be null");
            // to ensure "userIdType" is required (not null)
            this.UserIdType = userIdType ?? throw new ArgumentNullException("userIdType is a required property for AccountEnrollRequest and cannot be null");
        ...
        /// <summary>
        /// The account’s associated reward product identifier as defined by the client and configured during the implementation of the program.
        /// </summary>
        /// <value>The account’s associated reward product identifier as defined by the client and configured during the implementation of the program.</value>
        ...
        [DataMember(Name = "programIdentifier", IsRequired = true, EmitDefaultValue = false)]
        ...
        /// <summary>
        /// Identifier type of the User. Possible values are BCN (the Bank Customer Number) and RANCU (The unique account identifier assigned by Mastercard and provided to the client in the account enrollment)
        /// </summary>
        /// <value>Identifier type of the User. Possible values are BCN (the Bank Customer Number) and RANCU (The unique account identifier assigned by Mastercard and provided to the client in the account enrollment)</value>
        ...
        {
            return this.Equals(input as AccountEnrollRequest);
        }

        /// <summary>
        /// Returns true if AccountEnrollRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountEnrollRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountEnrollRequest input)
        {
            if (input == null)
                return false;
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if(this.AccountIdType != null && this.AccountIdType.Length > 30)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for AccountIdType, length must be less than 30.", new [] { "AccountIdType" });
            }
