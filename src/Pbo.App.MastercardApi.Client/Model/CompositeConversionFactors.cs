...
namespace Pbo.App.MastercardApi.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CompositeConversionFactors")]
    public partial class CompositeConversionFactors : IEquatable<CompositeConversionFactors>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompositeConversionFactors" /> class.
        /// </summary>
        ...
        public CompositeConversionFactors(string authRewardsServiceId = default(string), string name = default(string), string type = default(string), string currencyCode = default(string), CompositeOverrideCategoryDetails overrideCategoryDetails = default(CompositeOverrideCategoryDetails), List<ConversionRuleTier> conversionRuleTiers = default(List<ConversionRuleTier>))
        {
        ...
        public CompositeOverrideCategoryDetails OverrideCategoryDetails { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CompositeConversionFactors {\n");
        ...
        {
            return this.Equals(input as CompositeConversionFactors);
        }

        /// <summary>
        /// Returns true if CompositeConversionFactors instances are equal
        /// </summary>
        /// <param name="input">Instance of CompositeConversionFactors to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompositeConversionFactors input)
        {
            if (input == null)
                return false;
